...
const AgentInteractionModal = ({ 
  ...
  const generateAgentResponse = (userInput, agent) => {
    ...
    const agentResponses = responses[agent.agent_type] || responses['Intelligent Assistant'];
                ...
                {isTyping && (
                  <div className="flex justify-start">
                    <div className="bg-slate-700 text-white px-4 py-2 rounded-lg">
                      <div className="flex items-center space-x-2">
                        <Bot className="w-4 h-4" />
                        <span className="text-xs opacity-70">{agent.name} is typing...</span>
                      </div>
              ...
              <div className="text-center space-y-6">
                ...
                <div>
                  ...
                  <p className="text-slate-400">
                    {isRecording ? 'Recording... Tap to stop' : 'Tap to start voice conversation'}
                  </p>
                </div>
                <Button
            ...
            <div className="h-full flex flex-col items-center justify-center p-8">
              <div className="text-center space-y-6">
                <div className={`w-24 h-24 rounded-full flex items-center justify-center ${
                  ...
                  {isVideoCall ? <VideoOff className="w-12 h-12 text-white" /> : <Video className="w-12 h-12 text-white" />}
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Video Call</h3>
                  <p className="text-slate-400">
                    {isVideoCall ? 'Video call active... Tap to end' : 'Start video conversation with agent'}
                  </p>
                </div>
                <Button
          ...
          {activeTab === 'payment' && (
            <div className="h-full flex flex-col items-center justify-center p-8">
              <div className="text-center space-y-6 max-w-sm">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Agent Payment</h3>
                  ...
                  <div className="bg-slate-800 rounded-lg p-4 mb-4">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-white font-semibold">0.1 USDFC</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-slate-400">Network:</span>
                      <span className="text-purple-400">BlockDAG Testnet</span>
                    </div>
                  </div>
                </div>
