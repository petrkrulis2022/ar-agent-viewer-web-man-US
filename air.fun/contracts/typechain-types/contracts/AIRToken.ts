...
export interface AIRTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "INITIAL_SUPPLY"
      | "allowance"
...
export interface AIRToken extends BaseContract {
  connect(runner?: ContractRunner | null): AIRToken;
  waitForDeployment(): Promise<this>;

  interface: AIRTokenInterface;
